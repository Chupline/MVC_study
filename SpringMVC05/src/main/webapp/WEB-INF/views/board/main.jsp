...
<script type="text/javascript">
	...
	function makeView(data) { // data=[{ }, { }, { }, ...]
		...
		$.each(data,function(index, obj) {
			...
			// 게시판 작성자 아이디와 로그인 아이디가 동일해야 수정,삭제 가능
	...
	function goInsert() {
		...
		$.ajax({
			...
			data : fData,
			success : loadList,
			/* 스프링 보안에서 ajax통신시 post경우 토큰이름과 토큰값을 넘겨야 서비스 사용가능하게 해야하기 때문 */
...
<body>
	<div class="container">
    <!-- include page = "header.jsp" : header.jsp를 현재 jsp에 포함시킨다. -->
      ...
      <div class="panel-body" id="wform" style="display: none">
        <form id="frm">
          ...
          <table class="table">
            <tr>
              <td>제목</td>
              <!-- id: jquery에서 주로 사용 / name: 파라미터로 주로 사용  -->
            ...
            <tr>
              <td>작성자</td>
              <td><input type="text" class="form-control" id="writer" name="writer" value="${mvo.memName}" readonly /></td>
            </tr>
            <tr>
