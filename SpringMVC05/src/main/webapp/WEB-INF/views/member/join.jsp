  ...
  <div class="panel panel-default">
    <div class="panel-heading">회원가입</div>
       ...
       <form name="frm" action="${contextPath}/memRegister.do" method="post">
          ...
          <table class="table table-bordered" style="text-align: center; border: 1px solid #dddddd;">
            ...
            <tr>
              ...
              <td colspan="2"><input id="memAge" name="memAge" class="form-control" type="number" maxlength="20" placeholder="나이을 입력하세요."/></td>
            </tr>
            <tr>
              <td style="width: 110px; vertical-align: middle;">성별</td>
              <td colspan="2">
                <div clss="form-group" style="text-align: center; margin: 0 auto;">
            ...
            <tr>
              ...
              <td colspan="2">
              	...
              	<input type="checkbox" name="authList[1].auth" value="ROLE_MANAGER"/> ROLE_MANAMGE
              	<input type="checkbox" name="authList[2].auth" value="ROLE_ADMIN"/> ROLE_ADMIN</td>
            </tr>
            <tr>
          ...
          <!-- 스프링 보안에서 이름의 토큰 값을 받았을때 서비스를 허용한다. -->
     ...
     <!-- Modal -->
      ...
      <div class="panel-footer">Spring_MVC05(추경현)</div>
  </div>
</div>
